package com.xinyan.bigdata.base.gojira.test.dal.bean
...
class FiGwAgrtExpressOrderEncryptTestBean extends Serializable {
  ...
  /**
    * 
    **/
  var pay_member_id:Long = _
  
  /**
    * 终端号
    **/
  var terminal_id:Long = _
  ...
  /**
    * 
    **/
  var fee_member_id:Long = _
  
  /**
    * 手续费账户
    **/
  var fee_acct_id:Long = _
